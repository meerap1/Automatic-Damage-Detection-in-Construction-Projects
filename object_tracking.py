...
# Read JSON file
json_file_path = "path/to/your/json/file.json"  # Update this path
with open(json_file_path, 'r') as json_file:
    json_data = json.load(json_file)

# Get the bounding box from the first element in JSON data
first_bbox = json_data[0]['bbox']  # Assuming 'bbox' is the key for bounding box coordinates

# Initialize tracker with the first image and its bounding box
